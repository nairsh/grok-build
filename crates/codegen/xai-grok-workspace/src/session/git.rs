...
///
/// 1. `supplied_cwd` is a grok-managed worktree (`~/.atlas/worktrees/...`).
...
const REWIND_GIT_ENV: &str = "ATLAS_WORKSPACE_REWIND_GIT";
...
mod tests {
    ...
    fn test_effective_worktree_cwd_empty_offset() {
        let result =
            effective_worktree_cwd("/home/user/.atlas/worktrees/repo/ab-123-a", Path::new(""));
        assert_eq!(result, "/home/user/.atlas/worktrees/repo/ab-123-a");
    }
    #[test]
    fn test_effective_worktree_cwd_single_level_offset() {
        let result =
            effective_worktree_cwd("/home/user/.atlas/worktrees/repo/ab-123-a", Path::new("src"));
        assert_eq!(result, "/home/user/.atlas/worktrees/repo/ab-123-a/src");
    }
    #[test]
    fn test_effective_worktree_cwd_nested_offset() {
        let result = effective_worktree_cwd(
            "/home/user/.atlas/worktrees/repo/ab-123-b",
            Path::new("packages/frontend/src"),
        );
        assert_eq!(
            result,
            "/home/user/.atlas/worktrees/repo/ab-123-b/packages/frontend/src"
        );
    }
    #[test]
    ...
    fn test_effective_cwd_roundtrip_with_compute_offset() {
        ...
        let worktree_root = "/home/user/.atlas/worktrees/myrepo/ab-test-a";
...
mod restore_code_tests {
    ...
    fn restore_code_checkout_allowed_worktree_cwd_is_allowed() {
        let worktrees = Path::new("/home/u/.atlas/worktrees");
        assert!(restore_code_checkout_allowed_in(
            Path::new("/home/u/.atlas/worktrees/home-u-repo/2026-05-22-9f2e51ce"),
            Some("/home/u/repo"),
            worktrees,
        ));
    }
    ...
    fn restore_code_checkout_allowed_source_repo_with_worktree_session_is_refused() {
        ...
        assert!(!restore_code_checkout_allowed_in(
            Path::new("/home/u/repo"),
            Some("/home/u/.atlas/worktrees/home-u-repo/2026-05-22-9f2e51ce"),
            worktrees,
        ));
    }
    #[test]
