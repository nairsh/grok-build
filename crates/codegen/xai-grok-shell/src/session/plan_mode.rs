...
mod tests {
    ...
    fn plan_file_in_session_dir() {
        let t = PlanModeTracker::new(PathBuf::from("/home/user/.atlas/sessions/proj/abc-123"));
        assert_eq!(
            t.plan_file_path(),
            Path::new("/home/user/.atlas/sessions/proj/abc-123/plan.md")
        );
    }
    #[test]
    ...
    fn is_plan_file_write_exact_match() {
        let plan = Path::new("/home/user/.atlas/sessions/proj/abc/plan.md");
        let target = Path::new("/home/user/.atlas/sessions/proj/abc/plan.md");
