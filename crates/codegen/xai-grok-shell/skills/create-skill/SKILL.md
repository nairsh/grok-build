...
2. **Scope** - present the user with two options:
   - **Project** (Recommended): `<repo-root>/.atlas/skills/<name>/SKILL.md` - available only in this repo, shareable with teammates
   - **User**: `~/.atlas/skills/<name>/SKILL.md` - available in all projects
...
Where `<SKILL_DIR>` is:
- User scope: `~/.atlas/skills/<name>`
- Project scope: `<repo-root>/.atlas/skills/<name>`
