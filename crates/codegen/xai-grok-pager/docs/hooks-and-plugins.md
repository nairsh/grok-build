...
Plugin hooks automatically receive `ATLAS_PLUGIN_ROOT` and `ATLAS_PLUGIN_DATA` environment variables (see the [Plugins guide](../user-guide/09-plugins.md#environment-variables-in-plugin-hooks)).
