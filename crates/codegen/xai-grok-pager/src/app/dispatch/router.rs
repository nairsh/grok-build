...
use super::settings::setters::{
    clear_default_model, clear_explore_model, clear_fork_secondary_model, clear_task_model,
    ...
    set_default_selected_permission, set_display_refresh_auto_cadence, set_explore_model,
    ...
    set_simple_mode, set_task_model, set_theme, set_timeline, set_timestamps, set_vim_mode,
...
pub(crate) fn dispatch(action: Action, app: &mut AppView) -> Vec<Effect> {
    ...
    let effects = match action {
        ...
        Action::SetExploreModel(v) => set_explore_model(app, v),
        Action::ClearExploreModel => clear_explore_model(app),
