...
**File:** /root/.atlas/memory/MEMORY.md (lines 0-10)
```
## Project Conventions
...
"#;
        ...
        assert_eq!(results[0].path, "/root/.atlas/memory/MEMORY.md");
...
**File:** /root/.atlas/memory/ws/MEMORY.md (lines 1-5)
```
workspace content
```

### Result 2 (score: 0.42, source: session)
**File:** /root/.atlas/memory/ws/sessions/2026-05-01.md (lines 10-20)
```
session content
```
"#;
