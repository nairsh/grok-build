...
mod tests {
    ...
    fn test_rehydrate_registers_worktree_in_db() {
        ...
        // Isolate the worktree DB (lock + ATLAS_HOME → private tmp + restore).
        ...
        // global ATLAS_HOME) DB and INSERT-OR-REPLACE our row.
        ...
        // other subagent rows since ATLAS_HOME is process-global.
