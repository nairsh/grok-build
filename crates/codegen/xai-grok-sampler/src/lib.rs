...
pub use config::{
    AuthScheme, BearerResolver, HeaderInjector, OriginClientInfo, RetryPolicy,
    SERVICE_TIER_MARKER_HEADER, SamplerConfig, SharedBearerResolver, SharedHeaderInjector,
};
