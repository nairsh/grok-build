...
mod tests {
    ...
    fn refresh_local_install_picks_up_new_agent() {
        ...
        let mut registry = InstallRegistry::empty(home.join(".atlas").join("installed-plugins"));
        ...
        let trust = TrustStore::load_from(home.join(".atlas").join("trusted-plugins"));
    ...
    fn refresh_preserves_install_subdir_scope() {
        ...
        let mut registry = InstallRegistry::empty(home.join(".atlas/installed-plugins"));
    ...
    fn refresh_keeps_stale_when_legacy_subdir_scope_lost() {
        ...
        let install_dir = home.join(".atlas").join("installed-plugins");
