...
pub const GH_RELEASE_REPO: &str = "nairsh/grok-build";
...
pub struct UpdateConfig {
    ...
    /// Enterprise deployment key (ATLAS_DEPLOYMENT_KEY).
...
/// `~/.atlas/bin/grok` symlink target (`../downloads/grok-<version>-<platform>`)
...
/// link whose target binary was deleted (e.g. manual `~/.atlas/downloads`
...
/// `~/.atlas/version.json` (written by the auto-updater):
