...
This is an independent fork of xAI/SpaceXAI's Grok Build, maintained
privately; it is not affiliated with or supported by xAI/SpaceXAI. The public
tree is published for source transparency and local builds under the terms
of the Apache License, Version 2.0 (see [`LICENSE`](LICENSE)).
